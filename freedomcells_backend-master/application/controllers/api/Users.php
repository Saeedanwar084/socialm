...
/*=========== Swiming Api Start From Here =========*/
        ...
        {  
           ...
           $mail->SMTPDebug = 1;  
           $mail->SMTPAuth = true;  
           $mail->Host = 'espsofttechnologies.com';
           $mail->Port =465;
           $mail->Timeout = 3600;     
           $mail->Username = 'developer@espsofttechnologies.com';  
           $mail->Password = 'Espsoft123#';      
           $mail->SMTPSecure = "ssl";    
           $mail->SetFrom('admin@freedomcells.net');
 ...
 echo $this->ipfs_upload($_FILES['file']['tmp_name']);
      ...
      { 
        error_reporting('E_all');
         ...
         $this->email->from('info@freedomcell.com', 'Admin'); 
   ...
   public function register_post() {
        ...
        if ($chk_error) {
           ...
           $this->response($resp);
            ...
            $msg="Dear User, to complete your Freedomcells registration process, plese varify your email by follow this link  https://freedomcells.net/profilesetup?code=".$code;
       ...
       if($check_login){
        ...
        $userId=$check_login['id'];
            ...
            // CHECK USER WALLET
              ...
              $recdata=file_get_contents('http://blockchainexpert.co.in:7001/api/btc/create_wallet');
              //$recdata=file_get_contents('http://13.233.136.121:7001/api/testbtc/create_wallet');
              $data=json_decode($recdata,true);
              $btc_private=$data['data']['wallet']['private'];
              $btc_public=$data['data']['wallet']['public'];
